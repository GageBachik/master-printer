...
exports.createThawDelegatedAccountInstruction = void 0;
const splToken = __importStar(require("@solana/spl-token"));
const beet = __importStar(require("@metaplex-foundation/beet"));
const web3 = __importStar(require("@solana/web3.js"));
const ThawDelegatedAccountStruct = new beet.BeetArgsStruct([['instructionDiscriminator', beet.u8]], 'ThawDelegatedAccountInstructionArgs');
const thawDelegatedAccountInstructionDiscriminator = 27;
function createThawDelegatedAccountInstruction(accounts) {
