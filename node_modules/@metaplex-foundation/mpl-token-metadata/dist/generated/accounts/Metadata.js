...
class Metadata {
    constructor(key, updateAuthority, mint, data, primarySaleHappened, isMutable, editionNonce, tokenStandard, collection, uses) {
        this.key = key;
    ...
    static fromArgs(args) {
        return new Metadata(args.key, args.updateAuthority, args.mint, args.data, args.primarySaleHappened, args.isMutable, args.editionNonce, args.tokenStandard, args.collection, args.uses);
    }
    ...
    static deserialize(buf, offset = 0) {
        return exports.metadataBeet.deserialize(buf, offset);
    }
    serialize() {
        return exports.metadataBeet.serialize(this);
    }
